class Strings {
  static String welcome = 'Bem-vindo ao nosso App!';
  static String descriptionApp =
      'No nosso app você vai encontrar a lista dos filmes mais recentes disponíveis nos cinemas e streams';
  static String instructionOne =
